...
{
    // 🌟 Ổ KHÓA TỔNG: Đổi "Quản trị viên" thành "Administrator" cho khớp chính xác với Database
    ...
    public class ProductController : Controller
    {
        ...
        public IActionResult Edit(Product product, IFormFile? imageFile)
        {
            try
            {
                ...
                {
                    // Nếu không chọn file ảnh mới, giữ nguyên đường dẫn ảnh cũ của sản phẩm đó
        ...
        // ====================================================================================
        // 🌟 Ổ KHÓA RIÊNG BIỆT: Đổi thành "Administrator" để đồng bộ chuẩn chỉnh dữ liệu database
