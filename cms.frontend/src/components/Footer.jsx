                ...
                <div className="row">
                    ...
                    <div className="col-md-4 mb-4 mb-md-0">
                        <h4 className="font-weight-bold mb-3" style={{ color: '#11CAA0', letterSpacing: '1px' }}>
                            ThinhCMS<span className="text-white">.Kitchen</span>
                        </h4>
                        <p className="text-muted text-justify" style={{ fontSize: '14px', lineHeight: '1.6' }}>
                            Hệ thống cung cấp vật dụng nhà bếp cao cấp và tiện ích. Chúng tôi cam kết mang đến những sản phẩm chất lượng, giúp không gian bếp của gia đình bạn thêm tiện nghi và hiện đại.
                        </p>
                    </div>
                    ...
                    <div className="col-md-4">
                        ...
                        <ul className="list-unstyled text-muted" style={{ fontSize: '14px', lineHeight: '1.8' }}>
                            <li className="mb-2 d-flex align-items-start">
                                ...
                                <span>40/53, Đường 147, Phường Phước Long, TP Thủ Đức</span>
                            </li>
                            <li className="mb-2">
                                <i className="fas fa-phone-alt mr-2 text-info"></i> Hotline: 0902889970
                            </li>
                            <li className="mb-2">
                                <i className="fas fa-envelope mr-2 text-info"></i> support@ThinhKitchen.retail
                            </li>
                        </ul>
                    </div>
            ...
            <div className="copyright-bar py-3 mt-4" style={{ backgroundColor: '#1a1a1a', borderTop: '1px solid #2d2d2d' }}>
                <div className="container text-center">
                    <p className="m-0 text-muted" style={{ fontSize: '13px' }}>
                        &copy; {new Date().getFullYear()} <strong style={{ color: '#11CAA0' }}>ThinhCMS Retail</strong>. All Rights Reserved.
                    </p>
                </div>
            </div>
        </footer>
